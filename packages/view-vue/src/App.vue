...
import vuePath from '@/assets/vue.png'
import iversonIco from '@/assets/iverson.ico'
import iversonJpeg from '@/assets/iverson.jpeg'
import iversonWebp from '@/assets/iverson.webp'
...
// const vueUrl = useWebviewPublicPath(vuePath)
...
<template>
  <div style="display: flex;;">
    <div>
      <h4>svg</h4>
      <div><img :src="logPath" alt="" width="100" height="100"></div>
    </div>
    <div>
      <h4>png</h4>
      <div><img :src="vuePath" alt="" width="100" height="100"></div>
    </div>
    <div>
      <h4>ico</h4>
      <div><img :src="iversonIco" alt="" width="100" height="100"></div>
    </div>
    <div>
      <h4>jpeg</h4>
      <div><img :src="iversonJpeg" alt="" width="100" height="100"></div>
    </div>
    <div>
      <h4>webp</h4>
      <div><img :src="iversonWebp" alt="" width="100" height="100"></div>
    </div>
    <div>
      <h4>webp</h4>
      <div><img :src="iversonWebp" alt="" width="100" height="100"></div>
